...
<script type="text/javascript">
	$(function() {
		$('#kaptchaImage').click(
				function() {//生成验证码  
					$(this).hide().attr('src',
							'${appcontext}/core/validateCode?' + Math.floor(Math.random() * 100))
							.fadeIn();
		});
	});
</script>
...
<body>
	<div  class="login" align="center"  style="width:100%;height:auto">
		<fieldset style="width:400px;" >
			...
			<form id="loginForm" class="loginForm" action="${appcontext}/core/userLogin" method="post" style="text-align:left;">
				...
				<div align="center"><img src="${appcontext}/core/validateCode" width="55" height="20" id="kaptchaImage" style="margin-bottom: -3px" /></div>
				<div align="center" >
